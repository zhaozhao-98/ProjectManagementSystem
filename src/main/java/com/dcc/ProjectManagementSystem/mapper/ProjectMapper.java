...
public interface ProjectMapper {
	...
	List<Project> list_select_project_mod_all(@Param("project_list")int project_list, @Param("project_pm")int project_pm,@Param("customer") int customer,@Param("stat_tag")String  stat_tag, @Param("limit")int limit, @Param("item")int item);
