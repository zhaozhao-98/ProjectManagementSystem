...
public class CreateFile {
    //生成文件路径
    private static String path = "/home/tomcat/file_backup/temporary_pdf_html/";
    ...
    public static boolean delFile_pdf(String path,String fileName){
        Boolean bool = false;
     ...
     * @param fileName 文件名称
     */
    public static boolean delFile_other(String path,String fileName){
        Boolean bool = false;
        filenameTemp = path+fileName;
        File file  = new File(filenameTemp);
        try {
