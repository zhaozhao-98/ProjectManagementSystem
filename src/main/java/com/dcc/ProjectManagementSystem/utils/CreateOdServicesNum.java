...
public class CreateOdServicesNum {
    public static String odTestNum(int year, int month, int day, List<Project> nums) {
        Long count = VerifyTheNumber.VerifyOdNum(nums, year, month, day);
        //od编号 测试订单
    ...
    public static String odRoutineNum(int year, int month, int day, List<Project> nums) {
        //常规订单
        Long count = VerifyTheNumber.VerifyNum(nums, year);
